...
public class Main {
    ...
    public static void main(String[] args) throws AuthenticationException, RegistrationException {
        ...
        User fin = new User();
        fin.setEmail("fin@email.com");
        fin.setPassword("15613");
        userService.addUser(fin);
        authenticationService.login(fin.getEmail(), fin.getPassword());
        authenticationService.register("John@gmail.com", fin.getPassword());
    }
}
